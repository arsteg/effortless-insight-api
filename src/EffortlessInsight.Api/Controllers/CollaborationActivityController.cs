...
/// <summary>
/// Org-scoped collaboration activity feed (ActivityLogs). Previously named
/// ActivityController; renamed when the visitor-analytics ActivityController
/// was added — the routes are unchanged.
/// </summary>
[Authorize]
[ApiController]
[Route("api/v1")]
public class CollaborationActivityController : ControllerBase
{
    private readonly IActivityService _activityService;
    private readonly ICurrentOrganizationService _orgService;
    private readonly ILogger<CollaborationActivityController> _logger;

    public CollaborationActivityController(
        IActivityService activityService,
        ICurrentOrganizationService orgService,
        ILogger<CollaborationActivityController> logger)
    {
